...
public abstract class CameraActivity extends AppCompatActivity
  ...
  public static final int VIEW_NOTHING = 0;
  public static final int VIEW_SAVE_IMAGE = 1;
  ...
  private MenuItem mSaveImage,mTrain;
  public int mViewMode;
  public File dir;
  private MenuItem mnothing;
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    Log.d(this.getLocalClassName(),dir.toString());
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    Log.i(this.getLocalClassName(), "called onCreateOptionsMenu");
    mnothing = menu.add("Nothing");
    mclassify = menu.add("Classify");
    mSaveImage = menu.add("SaveImages");
    return true;
  }

  @Override
  public boolean onOptionsItemSelected(MenuItem item) {
    Log.i(this.getLocalClassName(), "called onOptionsItemSelected; selected item: " + item);
  ...
  protected void showDebugInfo(String DebugInfo) {
